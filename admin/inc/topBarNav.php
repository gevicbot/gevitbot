...
<!-- barra de navegación -->
      <nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <!-- <li class="nav-item">
            <a class="enlace de navegación" data-widget="barra de navegación-búsqueda" href="#" role="button">
            <i class="fas fa-busqueda"></i>
            </a>
            <div class="navbar-busqueda-block">
              <form class="form-inline">
                <div class="input-group input-group-sm">
                  <input class="form-control form-control-navbar" type="busqueda" placeholder="busqueda" aria-label="busqueda">
                  <div class="input-group-append">
                    <button class="btn btn-navbar" type="submit">
                    <i class="fas fa-search"></i>
                    </button>
                    <button class="btn btn-navbar" type="button" data-widget="navbar-busqueda">
